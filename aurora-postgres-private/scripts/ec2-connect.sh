ec2-connect() {
    ...
    info SSH "if success, execute on the instance :" "psql postgresql://$POSTGRES_USERNAME:$POSTGRES_PASSWORD@$HOST:5432/postgres?sslmode=require"
    # postgresql://$MASTER_USERNAME:$MASTER_PASSWORD@$HOST:5432/postgres?sslmode=require
